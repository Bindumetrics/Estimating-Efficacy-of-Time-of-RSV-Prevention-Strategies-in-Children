# ============================================================
# Bayesian Waning Efficacy Analysis - Severe RSV LRTI
# Fixed version for a SINGLE RDS file: Severe_RSV_LRTI.rds
...
# Your single R data file for the Severe RSV LRTI endpoint
DATA_FILE <- file.path(DATA_DIR, "Severe_RSV_LRTI.rds")

# Output folder for graphs and saved results
OUT_DIR <- file.path(DATA_DIR, "analysis_outputs_Severe_RSV_LRTI_BAYESIAN_ONLY")
...
p_km <- ggplot(km_plot_data,
  ...
  labs(title = "Kaplan-Meier Curves - Severe RSV LRTI",
       x = "Days since dosing",
...
save(models, agg_pla, agg_nir, data_pla_clean, data_nir_clean,
     ...
     file = file.path(OUT_DIR, "RSV_Hospitalization_waning_results_FIXED.RData"))
