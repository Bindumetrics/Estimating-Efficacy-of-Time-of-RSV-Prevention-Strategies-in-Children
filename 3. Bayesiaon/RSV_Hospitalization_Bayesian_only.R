# ============================================================
# Bayesian-Only Waning Efficacy Analysis - RSV Hospitalization
# Fixed version for a SINGLE RDS file: RSV_Hospitalization.rds
...
# Your single R data file for the RSV hospitalization endpoint
DATA_FILE <- file.path(DATA_DIR, "RSV_Hospitalization.rds")

# Output folder for graphs and saved results
OUT_DIR <- file.path(DATA_DIR, "analysis_outputs_RSV_Hospitalization_BAYESIAN_ONLY")
...
p_km <- ggplot(km_plot_data,
  ...
  labs(title = "Kaplan-Meier Curves - RSV Hospitalization",
       x = "Days since dosing",
...
save(models, agg_pla, agg_nir, data_pla_clean, data_nir_clean,
     ...
     file = file.path(OUT_DIR, "RSV_Hospitalization_Bayesian_only_results.RData"))
